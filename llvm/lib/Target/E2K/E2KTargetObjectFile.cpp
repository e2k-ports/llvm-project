//===------- E2KTargetObjectFile.cpp - E2K Object Info Impl -----------===//
//
...
void E2KELFTargetObjectFile::Initialize(MCContext &Ctx,
                                          const TargetMachine &TM) {
  TargetLoweringObjectFileELF::Initialize(Ctx, TM);
}

const MCExpr *E2KELFTargetObjectFile::getTTypeGlobalReference(
